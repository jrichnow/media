...
class TheMovieDbWrapperSpec extends PlaySpec {
  ...
  "TheMovieDbWrapper" should {
    ...
    "provide an actor JSON if found" in {
      ...
      JsonUtil.getIntValue(actorJson.get, "id").get mustBe (287)
      ...
      JsonUtil.getStringValue(actorJson.get, "poster").get mustBe ("http://image.tmdb.org/t/p/w342/2xrLcP4YRakx8aAc2jdwRbctr0Y.jpg")
    }
